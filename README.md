...
## Thesis description
Development of machine learning- and LLM-based geospatial tools for climate-resilient planning of water structures in rural India. As part of the open-source [CoRE Stack framework](https://core-stack.org/), these tools such as *Commons Connect*, is currently deployed across nine Indian states, are freely accessible and publicly hosted at [CoRE Stack](https://core-stack.org/).
