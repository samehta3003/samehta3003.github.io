...
## Thesis description
Development of machine learning- and LLM-based geospatial tools for climate-resilient planning of water structures in rural India. As part of the open-source [CoRE Stack framework](https://docs.google.com/presentation/d/1gBEctmvMI4E5ijBr8Zj58k3Fi-umJcgJ/edit?usp=drive_link&ouid=105881081359587580379&rtpof=true&sd=true), these tools such as *Commons Connect*, is currently deployed across nine Indian states, are freely accessible and publicly hosted at [CoRE Stack](core-stack.org).
...
2. **Mehta, S. A.**, Ashish, Solanki, M., & Seth, A. (2024). A Characterization of Land-use Changes in the Proximity of Mining Sites in India. ACM Journal on Computing and Sustainable Societies, 2(1), 1-23. [[Paper PDF]](https://dl.acm.org/doi/pdf/10.1145/3624774)
3. Sharma, V., **Mehta, S. A.**, Kumar, N., & Seth, A. (2024). Whose participation counts? towards technology-mediated equitable futures of development work. Proceedings of the ACM on Human-Computer Interaction, 8(CSCW2), 1-30. [[Paper PDF]](https://dl.acm.org/doi/pdf/10.1145/3686979)
4. Gupta, B., & **Mehta, S. A.** (2022). Dehazing from a Single Remote Sensing Image. In ICT Infrastructure and Computing: Proceedings of ICT4SD 2022 (pp. 409-418). Singapore: Springer Nature Singapore. [[Paper PDF]](https://www.researchgate.net/profile/Obianuju-Okeke-Uzodike/publication/368283399_Published-2022-Vol-3/links/63df96d4c97bd76a826ec293/Published-2022-Vol-3.pdf#page=413)
